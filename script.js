...
function configurarAnimacaoPontoColeta() {
    const frase = "No pátio principal em frente à área de alimentação da Universidade Salesiana de São Paulo de Campinas, obrigado por ajudar a cultivar a solidariedade em nossa sociedade.";
