...
function configurarAnimacaoVaquinha() {
    const frasePix = "Doe via Pix para contribuir para a aquisição de um novo forno duplo elétrico para a instituição Semente Esperança *copie a chave-pix ao clicar no botão abaixo, depois confirme sua doação nos botões com valores*";
